...
class Odin_Theme_Options {
	...
	public function callback_upload( $args ) {
		...
		$html = sprintf( '<input type="text" id="%1$s" name="%2$s[%1$s]" value="%3$s" class="regular-text"%5$s /> <input class="button odin-upload-button" id="%1$s-button" type="button" value="%4$s" />', $id, $tab, $current, __( 'Selecione o arquivo', 'odin' ), $this->build_field_attributes( $attrs ) );
